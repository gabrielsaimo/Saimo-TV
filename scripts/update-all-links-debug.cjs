                ...
                if (episodeInfo) {
                    for (const [m3uKey, m3uValue] of m3uEntries.entries()) {
                        ...
                        if (m3uEpisodeInfo) {
                            ...
                            if (episode.name.includes('Buffy')) {
                                console.log(`[SERIES] JSON Episode: ${episode.name} -> ${normalizedJsonBase}`);
                                console.log(`[SERIES] M3U Episode: ${m3uValue.originalName} -> ${normalizedM3uBase}`);
                            }
...
async function main() {
  console.log('Iniciando atualizacao de links enriched (debug)...');
